...
| 1. Tarefa                | 2. Requisitos ambíguos ou conflitantes                               | 1. Realizar workshops de levantamento com stakeholders. 2. Definir critérios de aceite claros. 3. Usar protótipos para validação.                        |
| 1. Tarefa                | 3. Mudanças frequentes de escopo durante a execução                  | 1. Estabelecer processo formal de controle de mudanças. 2. Avaliar impacto em prazo e custo antes de aprovar. 3. Revisar backlog com frequência.         |
...
| 2. Estrutura             | 2. Processos de aprovação lentos                                     | 1. Definir SLAs para decisões. 2. Delegar autoridade para o time. 3. Reduzir etapas de aprovação.                                                        |
| 2. Estrutura             | 3. Comunicação interna fragmentada                                   | 1. Estabelecer rituais de sincronização. 2. Centralizar decisões e registros. 3. Usar canais oficiais para mudanças.                                     |
...
| 3. Ator                  | 2. Alta rotatividade na equipe                                       | 1. Plano de retenção e reconhecimento. 2. Documentação contínua. 3. Pair programming para transferência de conhecimento.                                 |
| 3. Ator                  | 3. Falta de domínio do negócio                                       | 1. Treinamentos com especialistas do cliente. 2. Acompanhamento de usuários-chave. 3. Revisar requisitos com exemplos reais.                             |
...
| 4. Tecnologia            | 2. Ferramentas de build e deploy instáveis                           | 1. Automatizar pipelines com testes. 2. Monitorar falhas e tempos. 3. Manter versões suportadas.                                                         |
| 4. Tecnologia            | 3. Débito técnico acumulado                                          | 1. Reservar capacidade para refatoração. 2. Definir critérios de qualidade. 3. Revisar código periodicamente.                                            |
...
| 5. Tarefa-Ator           | 2. Sobrecarga de tarefas em membros-chave                            | 1. Balancear distribuição de trabalho. 2. Criar redundância de habilidades. 3. Monitorar capacidade da equipe.                                           |
| 5. Tarefa-Ator           | 3. Falhas de comunicação entre analistas e desenvolvedores           | 1. Refinamento conjunto de requisitos. 2. Documentação acessível e atualizada. 3. Reuniões curtas de alinhamento.                                        |
...
| 6. Tarefa-Tecnologia     | 2. Ambiente de testes não replica produção                           | 1. Padronizar infra com IaC. 2. Usar dados e configurações semelhantes. 3. Testes de carga antes de releases.                                            |
| 6. Tarefa-Tecnologia     | 3. Dependência de integrações não documentadas                       | 1. Mapear integrações e contratos. 2. Criar mocks para testes. 3. Estabelecer versionamento de APIs.                                                     |
...
| 7. Estrutura-Tarefas     | 2. Falta de priorização clara das tarefas                            | 1. Definir backlog priorizado por valor. 2. Revisar prioridades a cada ciclo. 3. Tornar critérios de prioridade explícitos.                              |
...
| 8. Ator-Tecnologia       | 2. Resistência à adoção de novas ferramentas                         | 1. Treinamentos práticos e tutoriais. 2. Suporte durante a transição. 3. Demonstrar ganhos com métricas.                                                 |
...
| 9. Ator-Estrutura        | 2. Conflitos entre áreas sobre responsabilidades                     | 1. Definir RACI e papéis claros. 2. Mediar conflitos com liderança. 3. Registrar decisões e responsabilidades.                                           |
...
| 10. Estrutura-Tecnologia | 2. Infraestrutura subdimensionada para a demanda                     | 1. Planejar capacidade com métricas. 2. Adotar escalabilidade horizontal. 3. Monitorar performance continuamente.                                        |
